      ...
      <BrowserRouter>
        <Layout>
          <Routes>
            ...
            <Route path="assistant-ui" element={<ChatAssistantUi />} />
            <Route path="copilot-kit" element={<ChatCopilotKit />} />
            <Route path="ai-sdk">
              <Route path="generative-user-interfaces" element={<AiSdkGenerative />} />
              <Route path="workflow" element={<AiSdkWorkflow />} />
              <Route path="network" element={<AiSdkNetwork />} />
              <Route path="generative-user-interfaces-with-custom-events" element={<AiSdkGenerativeCustomEvents />} />
            </Route>
            <Route path="client-tools">
              <Route path="ai-sdk" element={<ClientToolsAiSdk />} />
              <Route path="assistant-ui" element={<ClientToolsAssistantUi />} />
              <Route path="copilot-kit" element={<ClientToolsCopilotKit />} />
            </Route>
          </Routes>
        </Layout>
      </BrowserRouter>
